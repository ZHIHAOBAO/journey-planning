...
otp.core.Map = otp.Class({
    ...
    initialize : function(webapp) {
    	...
    	var greenIcon = L.icon(
    		{
    	        iconUrl: resourcePath + 'images/icons8-hospital-52.png',
    	        shadowUrl: null,
    	        iconSize: new L.Point(13, 23),
    	        iconAnchor: new L.Point(7, 23),
    	        popupAnchor: new L.Point(0, -23)
    	...
    	marker15.bindPopup(
    			...
    			+ "<br>Website: <a href='https://cbddoctorsmelbourne.com.au' target='_blank'>https://www.cbddoctorsmelbourne.com.au/?utm_source=Google%20MyBusiness&utm_medium=GMB&utm_campaign=Website%20Link</a>"
    	...
    	var greenIcon = L.icon(
    		{
    	        iconUrl: resourcePath + 'images/icons8-police-96.png',
    	        shadowUrl: null,
    	        iconSize: new L.Point(13, 23),
    	        iconAnchor: new L.Point(7, 23),
    	        popupAnchor: new L.Point(0, -23)
    	...
    	var point22 = [-37.81655, 144.96652];
    	var greenIcon = L.icon(
    		{
    	        iconUrl: resourcePath + 'images/icons8-police-96.png',
    	        shadowUrl: null,
